...
CLMBR_PATTERN = f"""
Сгенерируй объявление по типу: "Внимае! Каламбур!" или "Важное объявление!". 
Требование к объявлению: {__BASE_REQS__.replace(__REPLACEMEWORDSCOUNT__, '3')}
Добавь объявление к каламбуру '{REPLACEEXTRADATA}' и пришли полный текст. Оригинальный каламбур оставь без редактирования.
"""

STICK_PATTERN = f"""
Человек с ником {REPLACEEXTRADATA} вытянул короткую палку и будет кикнут с канала.
Сгенерируй для него прощальные слова. Требования к прощанию:
{__BASE_REQS__.replace(__REPLACEMEWORDSCOUNT__, '7')}
- злорадное;
- без одинарных и двойных ковычек;
- ник должен быть на русском языке;

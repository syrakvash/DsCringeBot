...
CLMBR_PATTERN = f"""
Придумай важное объявление для сообщения ниже по типа: "Внимае! Каламбур!" или "Важное объявление!". 
Требование к объявлению: {__BASE_REQS__.replace(__REPLACEMEWORDSCOUNT__, '1')}
Каламбур: {REPLACEEXTRADATA}
Итоговый ответ должен содержать объявление и оригинальный каламбур без редактирования.
"""
